...
public class Level_1 : Node2D
{
    ...
    private AnimationPlayer _circleAnimation;
    ...
    public override void _Ready()
    {
        ...
        _circleAnimation = GetNode<AnimationPlayer>("CircleAnimation");
        _circleAnimation.CurrentAnimation = "New Circle";
